...
```javascript
import BinaryStrided1dDispatch from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-binary-reduce-strided1d-dispatch@v0.1.1-esm/index.mjs';
```
...
```javascript
import base from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray-gdot@esm/index.mjs';
